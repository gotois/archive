...
export default {
  ...
  oidc: {
    linkName:
      ...
      'Если у вас возникли вопросы или вам требуется дополнительная помощь, пожалуйста, обратитесь к документации или свяжитесь с нашей службой поддержки. Мы готоввы ответить на все ваши вопросы использования нашего сервиса.',
  ...
  tutorial: {
    ...
    info: {
      ...
      body:
        'Наш сервис работает по следующему принципу: мы фиксируем условия договоренностей в надежном хранилище, доступном только вам либо на вашем физическом устройстве либоа на вашем SOLID-сервере.' +
