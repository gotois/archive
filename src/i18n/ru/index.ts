...
export default {
  ...
  oidc: {
    linkName:
      'Чтобы продолжить использование нашего сервиса, введите ниже адрес OIDC Issuer (Отправитель идентификаторов открытых токенов), чтобы получить ваш уникальный идентификатор (WebID).' +
    ...
    issuerHint: 'Выберите URL адрес или введите свой собственный',
