export default {
  ...
  tutorial: {
    agreement: {
      ...
      body: 'Разработчик не осуществляет сбор ваших персональных данных.',
    },
    license: {
      title: 'Пользовательское соглашение',
      body: 'Приложение распространяется "как есть". Исходный код распространяется по лицензии MIT. Разработчик не гарантирует сохранность ваших документов. Разработчик вправе внести изменения конфликтующие с вашими сохраненными документами.',
    },
    data: {
